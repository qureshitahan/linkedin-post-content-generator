  ...
  return (
    <div className="card">
      ...
      <p className="mb-4 text-sm text-slate-500">
        Your goal was expanded into search queries run across News, Reddit, Hacker News & X. The count shows
        how many <span className="font-medium">on-topic</span> posts each query surfaced after filtering out
        noise and dead posts.
      </p>
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th className="px-4 py-2 text-right font-medium text-slate-600">On-Topic Posts</th>
            </tr>
          </thead>
